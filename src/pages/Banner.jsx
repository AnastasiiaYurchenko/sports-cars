      ...
      {cars && cars.length > 0 && cars.slice(0, 5).map((car, index) => {
        ...
        return <div key={car._id} className={`slide ${car.active ? 'active' : undefined}`}>
              ...
              <div className="col-lg-4 p-0">
                <div className="banner-img">
                  <img src={car.leftImg} alt={car.make} className='img-fluid'/>
                </div>
                  </div>
              <div className="col-lg-5 p-0">
                <div className="car-description">
                  ...
                  <div className="car-features">
                    <p>{car.description}</p>
                    <Link to={`/vehicles/${car._id}`} className='detail-link text-center'>Explore <i className="bi bi-arrow-right-short"></i></Link>
                  </div>
                </div>
                  </div>
              <div className="col-lg-3 p-0">
                <img src={car.rightImg} alt={car.make} className='img-fluid'/>
                  </div>
                </div>
